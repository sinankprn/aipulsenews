...
faq:
- a: Economists, who previously dismissed the job threat posed by Artificial Intelligence,
    no longer hold that dismissive view.
  q: What is the main development reported regarding economists' views on AI?
- a: This trending story was found across one source.
  q: How many sources confirmed this trending story for AI Pulse?
- a: Economists once dismissed the A.I. job threat.
  q: What was the prior stance of economists regarding the AI job threat?
image: /assets/images/posts/economists-once-dismissed-the-ai-job-threat-but-no.png
layout: post
sources:
